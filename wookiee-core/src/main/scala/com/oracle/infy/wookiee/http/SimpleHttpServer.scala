...
import com.oracle.infy.wookiee.health.{ApplicationHealth, ComponentState, HealthComponent, HealthRequest, HealthResponseType}
...
class SimpleHttpServer(port:Int=8008) extends HActor with ComponentHelper {
  ...
  def respond(httpExchange: HttpExchange, response:String, responseStatus:Int=200, contentType:String="text/plain"): Unit = {
