...
object Concurrent {
  ...
  def buffer[E](maxBuffer: Int, length: Input[E] => Int)(implicit ec: ExecutionContext): Enumeratee[E, E] = new Enumeratee[E, E] {
    ...
    import scala.concurrent.stm._
    import com.webtrends.harness.libs.iteratee.Enumeratee.CheckDone
   ...
   * [[com.webtrends.harness.libs.iteratee.Concurrent.Channel]] that can be used to feed input into the iteratee.  However, note that
