...
/**
  * @author Michael Cuthbert on 10/29/14.
  */
trait Metrics {
  this: Actor =>

  implicit val monitorSettings: MonitoringSettings

  def startMetrics: ActorRef = {
    // Hookup the main communication actor
    context.actorOf(MetricsActor.props(monitorSettings), Metrics.MetricsName)
  }
}
