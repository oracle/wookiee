# Wookie - Component: Socko Config

Entry name for config is "wookie-socko". This would be the string you would use in lib-components if using that mechanism to load components.
